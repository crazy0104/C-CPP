...
{CDLL_VERSION_NAME, (CAPL_FARCALL)CDLL_VERSION, "", "", CAPL_DLL_CDECL, 0xabcd, CDLL_EXPORT },
  ...
  {"xbSetCustomType",(CAPL_FARCALL)SetCustomType ,"XB_SECURITY_ALG","This function will set custom type. ", 'V',1,"D","",{"type"}},
  {"xbSetMaskValue",(CAPL_FARCALL)SetMaskValue ,"XB_SECURITY_ALG","This function will set a mask based on type. A or B can be selected.", 'V',2,"DD","",{"value","type"}},
  {"xbSetBootSecurityLevel",(CAPL_FARCALL)SetBootSecurityLevel ,"XB_SECURITY_ALG","This function will set boot security level. ", 'V',1,"D","",{"value"}},
  {"xbSeedToKey",(CAPL_FARCALL)SeedToKey ,"XB_SECURITY_ALG","This function will calculate a key based on seed.The return value is the key ", 'D',3,"DDD","",{"u32seed","u32SecurityLevel","u32Cnt"}},

  {"xbGetBaseAddr",(CAPL_FARCALL)GetBaseAddress,"XB_FILE_READ","If result equals 0xFFFFFF, it indicates obtaining a base address, or failing to obtain a valid address", 'D',2,"CD","\001\000",{"lineDatas","len"}},
  {"xbGetValidAddr",(CAPL_FARCALL)GetValidAddress ,"XB_FILE_READ","Get a line of addr ", 'D',2,"CD","\001\000",{"lineDatas","len"}},

  /*{"dllHMAC-SHA1",(CAPL_FARCALL)vGS_SecurityAlgorithm ,"CAPL_DLL","This function will calculate a key based on seed.It's HMAC-SHA1 algorithm ", 'D',3,"BBB","\000\001",{"bSeed","bMask","bRes"}},*/
